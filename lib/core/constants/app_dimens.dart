class AppDimens {
  ...
  static const double extraSmallSpace = 4.0;

  static const double smallBorderRadius = 4.0;
  static const double defaultBorderRadius = 8.0;
  static const double largeBorderRadius = 12.0;
  static const double extraLargeBorderRadius = 20.0;
  static const double largeButtonBorderRadius = 26.0;
  ...
  static const double svgSizeMedium = 20.0;
  static const double svgSizeLarge = 24.0;
  static const double svgSizeExtraLarge = 28.0;
  static const double svgSizeSuperExtraLarge = 32.0;
  static const double svgSizeSuperSuperExtraLarge = 64.0;
