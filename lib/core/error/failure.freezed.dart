...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( ServerFailure value)?  server,TResult Function( CacheFailure value)?  cache,TResult Function( NetworkFailure value)?  network,TResult Function( MessageFailure value)?  message,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return network(_that);case MessageFailure() when message != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( ServerFailure value)  server,required TResult Function( CacheFailure value)  cache,required TResult Function( NetworkFailure value)  network,required TResult Function( MessageFailure value)  message,}){
final _that = this;
switch (_that) {
case ServerFailure():
return server(_that);case CacheFailure():
return cache(_that);case NetworkFailure():
return network(_that);case MessageFailure():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( ServerFailure value)?  server,TResult? Function( CacheFailure value)?  cache,TResult? Function( NetworkFailure value)?  network,TResult? Function( MessageFailure value)?  message,}){
final _that = this;
switch (_that) {
case ServerFailure() when server != null:
return server(_that);case CacheFailure() when cache != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String message)?  server,TResult Function( String message)?  cache,TResult Function( String message)?  network,TResult Function( String message)?  message,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ServerFailure() when server != null:
...
return network(_that.message);case MessageFailure() when message != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String message)  server,required TResult Function( String message)  cache,required TResult Function( String message)  network,required TResult Function( String message)  message,}) {final _that = this;
switch (_that) {
case ServerFailure():
return server(_that.message);case CacheFailure():
return cache(_that.message);case NetworkFailure():
return network(_that.message);case MessageFailure():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String message)?  server,TResult? Function( String message)?  cache,TResult? Function( String message)?  network,TResult? Function( String message)?  message,}) {final _that = this;
switch (_that) {
case ServerFailure() when server != null:
return server(_that.message);case CacheFailure() when cache != null:
return cache(_that.message);case NetworkFailure() when network != null:
...
class MessageFailure implements Failure {
...
/// @nodoc
abstract mixin class $MessageFailureCopyWith<$Res> implements $FailureCopyWith<$Res> {
